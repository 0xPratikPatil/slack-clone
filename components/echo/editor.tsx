      ...
      >
        ...
        <div className="z-[5] flex px-2 pb-2">
          <Hint label={isToolbarVisible ? 'Hide formatting' : 'Show formatting'}>
            <Button disabled={disabled} size="icon" variant="ghost" onClick={toggleToolbar}>
          ...
          {variant === 'create' && (
            <Hint label="Image">
              <Button disabled={disabled} size="icon" variant="ghost" onClick={() => imageElementRef.current?.click()}>
